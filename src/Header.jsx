        ...
        <section className="container main-hero-container">
          <div className="row">
            ...
            <div className="col-12 col-lg-6 header-left-side d-flex justify-content-center flex-column align-items-start">
              ...
              <p className='main-hero-para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore laudantium sit eos debitis impedit non culpa repudiandae facere similique, iure at consectetur! In quidem, ratione officia dolorem quas porro voluptate.</p>
